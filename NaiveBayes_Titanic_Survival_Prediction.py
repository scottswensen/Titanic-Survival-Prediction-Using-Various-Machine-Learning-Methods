# Prediction of survival on the Titanic using Random Forests
...
# Visualize survival data by age
plt.figure()
fig, ax = plt.subplots()
binsize = 30
...
# Fit the Random Forests model to the data
from sklearn.naive_bayes import GaussianNB
model_nb = GaussianNB()
model_nb.fit(X_train_sc, y_train)
pred_nb = model_nb.predict(X_test_sc)
